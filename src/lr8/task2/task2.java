...
public class task2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\user\\IdeaProjects\\java_course2023\\src\\lr8\\task2\\File1.txt"), "cp1251"));
            out = new PrintWriter("C:\\Users\\user\\IdeaProjects\\java_course2023\\src\\lr8\\task2\\File2.txt", "cp1251");
            int lineCount = 0;
            String s;
